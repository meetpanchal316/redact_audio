...
# ============ CONFIGURATION ============
INPUT_AUDIO_PATH = "D:/music/english/SHRIYASHVM1.ogg"
OUTPUT_AUDIO_PATH = "D:/music/english/censored_SHRIYASHVM1.mp3"
...
print("📝 Transcribing audio (may take a while)...")
result = model.transcribe(INPUT_AUDIO_PATH)

print("⏱️ Force-aligning words for accurate timestamps...")
model_a, metadata = whisperx.load_align_model(language_code=result["language"], device="cpu")
result_aligned = whisperx.align(result["segments"], model_a, metadata, INPUT_AUDIO_PATH, device="cpu")

# ============ STEP 2: EXTRACT WORDS & BUILD RAW TRANSCRIPT ============
print("\n🗣️ Extracted words from audio:\n")
word_segments = result_aligned["word_segments"]
all_words = [w["word"] for w in word_segments]
print(" ".join(all_words))
transcript_text = " ".join(all_words)
print(f"\nTotal extracted words: {len(all_words)}")
